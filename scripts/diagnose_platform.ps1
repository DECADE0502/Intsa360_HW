...
# Loader checks include InsertXMLMenu entries for the two default ASCII top-menu items.
# Opt-in Cadence scripts may still inject extra actions through AddAccessoryMenu.
$S = @{
  ...
  OpenLine = '"action" "Open Platform"'
  ExportLine = '"action" "Export and Process BOM"'
