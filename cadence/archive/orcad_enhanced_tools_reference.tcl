#/////////////////////////////////////////////////////////////////////////////////
# 功能: OrCAD Capture 脚本增强工具，包含 NC 处理、网络名处理、Value 隐藏、脱敏和混淆等功能。
# 安装方法: 将本脚本文件放置到 Cadence 安装目录 %CDSROOT%/tools/capture/tclscripts/capAutoLoad/ 后启动 Capture。
# 使用方法: 通过菜单 Accessories -> orCAD Enhanced Tools 选择相应工具。
# 版本: V0.3 作者: whoishu666@outlook.com
# 版本: V0.4 作者: alain@vfeda.com，新增隐藏 U 位号器件 Value。
# 版本: V0.5 作者: alain@vfeda.com，新增隐藏所有器件 Value。
# 版本: V0.6 作者: jadenzeng@insta360.com，新增 Net/Port/Offpage/Power 指定字符串替换。
# 版本: V0.7 作者: jadenzeng@insta360.com，新增删除 TitleBlocks 和 Text。
# 版本: V0.8 作者: jadenzeng@insta360.com，网络替换改为可视化界面。
# 版本: V0.9 作者: jadenzeng@insta360.com，新增随机网络替换。
# 版本: V1.0 作者: jadenzeng@insta360.com，新增一键删除图片。
# 版本: V1.1 作者: jadenzeng@insta360.com，新增一键删除线段。
# 版本: V1.2 作者: jadenzeng@insta360.com，新增一键隐藏芯片 Pin 名。
# 版本: V1.8 作者: wuqiyou@insta360.com，集成 NC 快捷切换、按要求脱敏/恢复、反向操作、敏感属性隐藏和性能优化。
...
proc ::capMenuUtil::addDesignAccessoryMenu { } {
    AddAccessoryMenu "orCAD Enhanced Tools" "选中器件切换NC (Ctrl+Q)" "::capNCToggleSelected::toggleFromMenu"
    AddAccessoryMenu "orCAD Enhanced Tools" "显示GND网络名" "::capMenuUtil::GroundNameVisible"
    AddAccessoryMenu "orCAD Enhanced Tools" "隐藏GND网络名" "::capMenuUtil::GroundNameHidden"
    AddAccessoryMenu "orCAD Enhanced Tools" "网络名替换" "::capMenuUtil::showNetNameExchangeDialog"
    AddAccessoryMenu "orCAD Enhanced Tools" "NC器件置灰" "::capMenuUtil::NcPartGrayed"
    AddAccessoryMenu "orCAD Enhanced Tools" "恢复器件默认颜色" "::capMenuUtil::RestorePartDefaultColor"
    AddAccessoryMenu "orCAD Enhanced Tools" "NC器件Value改为NC" "::capMenuUtil::confirmGrayedPartToNC"
    AddAccessoryMenu "orCAD Enhanced Tools" "恢复网络名颜色" "::capMenuUtil::ResetNetnameColor"
    AddAccessoryMenu "orCAD Enhanced Tools" "随机化网络名" "::capMenuUtil::confirmRandomizeNetNames"
    AddAccessoryMenu "orCAD Enhanced Tools" "删除所有图形" "::capMenuUtil::confirmDeleteAllGraphic"
    AddAccessoryMenu "orCAD Enhanced Tools" "删除文本和标题栏" "::capMenuUtil::confirmDeleteTextTitleblocks"
    AddAccessoryMenu "orCAD Enhanced Tools" "隐藏U器件Value" "::capMenuUtil::confirmHideUcomponent"
    AddAccessoryMenu "orCAD Enhanced Tools" "显示U器件Value" "::capMenuUtil::confirmShowUcomponent"
    AddAccessoryMenu "orCAD Enhanced Tools" "隐藏所有器件Value" "::capMenuUtil::confirmHideALLcomponent"
    AddAccessoryMenu "orCAD Enhanced Tools" "显示所有器件Value" "::capMenuUtil::confirmShowALLcomponent"
    AddAccessoryMenu "orCAD Enhanced Tools" "隐藏U器件Pin名" "::capMenuUtil::confirmHideUPinNames "
    AddAccessoryMenu "orCAD Enhanced Tools" "一键按要求脱敏" "::capRequiredSanitize::sanitizeFromMenu"
    AddAccessoryMenu "orCAD Enhanced Tools" "恢复按要求脱敏" "::capRequiredSanitize::restoreFromMenu"
    AddAccessoryMenu "orCAD Enhanced Tools" "一键混淆原理图" "::capMenuUtil::confirmSchematicObfuscation"
}
# ////////////////////////////////////////////////////////////////////////////////
...
catch {DeleteXMLMenu [list OrCADEnhancedToolsTopMenu]}
catch {RefreshMenu}
# ////////////////////////////////////////////////////////////////////////////////
# Selected part NC toggle hotkey. Visible text may be localized; function names stay stable.
# ////////////////////////////////////////////////////////////////////////////////
...
proc ::capNCToggleSelected::toggle {} {
    if {![::capNCToggleSelected::enabled]} {
        catch {tk_messageBox -icon info -type ok -title "切换选中器件 NC" -message "请先选中一个或多个器件。"}
...
catch {RegisterAction "NC Toggle Selected Parts" "::capNCToggleSelected::enabled" "Ctrl+Q" "::capNCToggleSelected::toggle" "Schematic"}
puts {orCAD Enhanced Tools NC toggle loaded: Ctrl+Q}